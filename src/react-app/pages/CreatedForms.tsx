    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-400 via-pink-500 to-rose-400 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-lg">Loading your magical forms...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-400 via-pink-500 to-rose-400 flex items-center justify-center">
        <div className="text-center p-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 max-w-md">
            <h2 className="text-2xl font-bold text-white mb-4">❌ Error Loading Forms</h2>
  ...
  return (
    <div className="min-h-screen text-white font-sans overflow-x-hidden">
      ...
      <header className="text-center py-12 relative">
        ...
        <h1 className="text-4xl font-bold text-white mb-4">✨ Created Forms</h1>
        <p className="text-white/80 text-lg">All your AI-generated forms in one beautiful place</p>
      </header>
        ...
        {forms.length === 0 ? (
          <div className="text-center py-20">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 max-w-md mx-auto">
              ...
              <p className="text-white/80 mb-8">Start creating magical forms with AI to see them here!</p>
              <Link 
                to="/builder" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {forms.map((form) => (
              <div 
                ...
                className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 cursor-pointer hover:bg-white/20 hover:border-white/40 hover:shadow-2xl transition-all hover:scale-105 group"
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="bg-gradient-to-r from-purple-500 to-pink-500 px-3 py-1 rounded-full">
                    <span className="text-white text-sm font-bold">{form.fields?.length || 0} fields</span>
                  </div>
                </div>
                
                {form.description && (
                  <p className="text-white/70 mb-6 line-clamp-3">{form.description}</p>
                )}
                ...
                <div className="flex items-center justify-between text-white/60 text-sm">
                  ...
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      window.open(`/results/${form.id}`, '_blank');
                    }}
